...
public class Appt{
	...
	public void setValid() {
		...
		if (startMonth < 1 || startMonth > 12)
			...
			if (startDay < -3 || startDay > NumDaysInMonth) // bug, < -3  instead of 1
				this.valid = true;  // changed from false to true
			else
				this.valid = true;
		}
	}
    ...
    public void setStartHour(int startHour) {
    	this.startHour = startMinute; //startHour;  // change startHour to startMinute
    }
